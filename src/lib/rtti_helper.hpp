...
//		{
//			uintptr_t xref = (uintptr_t)findpattern(start, ida_pattern, size);
//
...
//
//		uintptr_t rtti_type_descriptor = (uintptr_t)utils::pattern_scan(module_name, ida_pattern);
...
//
//				const uintptr_t vtable_address = (uintptr_t)utils::pattern_scan(rdata_start, ida_pattern, rdata_size) + 0x4;
//
...
//				return (uintptr_t*)utils::pattern_scan(text_start, ida_pattern, text_size);
//			}
//		}
//
